	.file	"constant_propagation_d_test.c"
...
# sources/constant_propagation_d_test.c:3:     const int x = 4;
	mov	DWORD PTR -8[rbp], 4	# x,
# sources/constant_propagation_d_test.c:4:     int y = x + 2;
	mov	eax, DWORD PTR -8[rbp]	# tmp103, x
	add	eax, 2	# y_2,
	mov	DWORD PTR -4[rbp], eax	# y, y_2
# sources/constant_propagation_d_test.c:5:     return 0;
	mov	eax, 0	# _3,
# sources/constant_propagation_d_test.c:6: }
	pop	rbp	#
	.cfi_def_cfa 7, 8
	ret	
	.cfi_endproc
